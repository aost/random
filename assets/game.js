...
Opal.modules["owl"] = function($opal) {
  ...
  $opal.add_stubs(['$[]', '$/', '$move', '$bounce', '$display', '$+', '$*', '$<', '$y', '$>', '$size', '$y=', '$x', '$x=', '$push', '$translate', '$scale', '$sin', '$rotate_z', '$image_cropped', '$pop']);
  return (function($base, $super) {
    ...
    $opal.cdecl($scope, 'CROP_SIZE', $scope.get('V')['$[]'](135, 80));

    $opal.cdecl($scope, 'CROP_POSITION', $scope.get('V')['$[]'](80, 70));

    $opal.cdecl($scope, 'CENTER_POSITION', $scope.get('CROP_SIZE')['$/'](-2));

    def.$initialize = function() {
      var self = this;

      self.image = $scope.get('Image')['$[]']("brown-owl.jpg");
    ...
    def.$bounce = function(display) {
      ...
      if ((($a = ((($b = self.position.$y()['$<'](0)) !== false && $b !== nil) ? $b : self.position.$y()['$+'](self.image.$size().$y())['$>'](display.$size().$y()))) !== nil && (!$a.$$is_boolean || $a == true))) {
        ($a = self.direction, $a['$y=']($a.$y()['$*'](-1)))};
      if ((($a = ((($b = self.position.$x()['$<'](0)) !== false && $b !== nil) ? $b : self.position.$x()['$+'](self.image.$size().$x())['$>'](display.$size().$x()))) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    return (def.$draw = function(d) {
      ...
      d.$image_cropped(self.image, $scope.get('CENTER_POSITION'), $scope.get('CROP_POSITION'), $scope.get('CROP_SIZE'));
      return d.$pop();
    }, nil) && 'draw';
  })(self, null)
};
...
(function($opal) {
  ...
  $opal.add_stubs(['$require', '$attr_reader', '$new', '$text_font=', '$[]', '$d', '$text_size=', '$pressed?', '$keyboard', '$!', '$fill_color=', '$clear', '$draw_assorted_shapes_and_text', '$update', '$draw', '$display', '$stroke_color=', '$stroke_width=', '$fill_text', '$fill_rectangle', '$stroke_rectangle', '$stroke_line', '$begin_shape', '$move_to', '$curve_to', '$curve2_to', '$line_to', '$end_shape', '$stroke_shape', '$fill_shape', '$fill_ellipse', '$stroke_ellipse']);
  self.$require("math");
  self.$require("owl");
  return (function($base, $super) {
    function $RandomGame(){};
    ...
    def.$setup = function() {
      ...
      self.paused = false;
      (($a = [$scope.get('Font')['$[]']("deja-vu-serif.ttf")]), $b = self.$d(), $b['$text_font='].apply($b, $a), $a[$a.length-1]);
      return (($a = [54]), $b = self.$d(), $b['$text_size='].apply($b, $a), $a[$a.length-1]);
    };
    ...
    def.$update = function(elapsed) {
      ...
      if ((($a = self.paused) !== nil && (!$a.$$is_boolean || $a == true))) {
        return nil};
